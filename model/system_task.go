...
const (
	...
	SystemTaskTypeLiandongPoll   = "liandong_reconcile"
	SystemTaskTypeQuotaReclaim   = "redemption_quota_reclaim"
)
...
func ListSystemTasksByTypePage(taskType string, status string, page int, pageSize int) ([]*SystemTask, int64, error) {
	if page < 1 {
		page = 1
	}
	if pageSize < 1 {
